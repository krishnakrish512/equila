<footer class="site-footer">
    <div class="site-wrapper">
        <div class="md-d-flex">
            <a href="#" class="ftr-logo   wow fadeIn" data-wow-offset="0" data-wow-delay="0.3s">
                <img src="img/color-logo.svg" alt="">
            </a>
            <div class="mt-copyright   wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
                <p>© Copyright 2022 EQUILA ST IVES. <span>All Rights Reserved.</span>
